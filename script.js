...
const bookComp = function (number, title, sub, text) {
  return `
      <div class="card">
...
books.cards.map((book,i) => cardsContainer.insertAdjacentHTML("beforeend",bookComp(i+1, book.title,book.sub, book.text)));
